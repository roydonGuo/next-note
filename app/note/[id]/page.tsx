...
import { ArrowLeft, Calendar, Tag as TagIcon, FolderOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-zinc-950 dark:via-blue-950 dark:to-indigo-950">
      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <article className="relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-zinc-200/50 dark:border-zinc-800/50 p-8 md:p-10">
          {/* 装饰性渐变 */}
          ...
          <header className="relative mb-8 pb-6 border-b border-zinc-200/50 dark:border-zinc-700/50">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <Link
                ...
                className={`group inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl ${categoryColor} hover:scale-105 transition-all shadow-md hover:shadow-lg`}
              >
                <FolderOpen className="w-4 h-4" />
                {note.category}
              </Link>
              <div className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 bg-zinc-100/50 dark:bg-zinc-800/50 px-3 py-2 rounded-xl">
